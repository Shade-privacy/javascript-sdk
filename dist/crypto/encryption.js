...
export class EncryptionService {
    ...
    async deriveStorageKey(walletSignature) {
        ...
        const baseKey = await crypto.subtle.importKey('raw', signatureBuffer, { name: 'HKDF' }, false, ['deriveKey']);
        ...
        return crypto.subtle.deriveKey({
            ...
            hash: 'SHA-256'
        }, baseKey, { name: SHADE_DOMAIN.ENCRYPTION_ALGORITHM, length: 256 }, false, ['encrypt', 'decrypt']);
    }
    /**
    ...
    async importKey(base64Key) {
        ...
        return crypto.subtle.importKey('raw', keyBuffer, { name: SHADE_DOMAIN.ENCRYPTION_ALGORITHM }, true, ['encrypt', 'decrypt']);
    }
}
